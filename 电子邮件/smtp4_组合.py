...
msg.attach(MIMEText('<html><body><h1>Hello</h1>' +
                    '<p><img src="cid:0"></p><p><img src="cid:1"></p>' +
...
with open('左上角.png', 'rb') as f:
    # 设置附件的MIME和文件名
    mime = MIMEBase('image', 'png', filename='左上角.png')
    # 加上必要的头信息
    mime.add_header('Content-Disposition', 'attachment', filename='左上角.png')
